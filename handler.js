...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = namabot
        global.colong1 = 'Ciss '
        global.colong2 = 'By Pilar'
        global.kontak2 = [
        ['6288212514602', 'PilarBilek', 'Raja Satir Bilek', 'pilarbilek302@gmail.com', true],
        ['6288212514602', await this.getName('6288212514602@s.whatsapp.net'), 'Bilek', 'sa0066588@gmail.com', true],
        ['628818172681', 'BOTKANJUD', 'Bot WhatsApp', 'Nothing!', true],
        ]
        ...
        try {
            ...
            try {
             ...
             if (!isNumber(user.ayam)) user.ayam = 0
                    ...
                    if (!isNumber(user.lastlastramuanclaim)) user.lastramuanclaim = 0
                ...
                if (chat) {
                    ...
                    if (!('gem' in chat)) chat.delete = true
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.sendTemplateButtonLoc(id, await conn.resize(action === 'add' ? wel : lea, 280, 150), text, wm, 'MENU', '.m')
...
global.dfail = async (type, m, conn) => {
    ...
    if (msg) return conn.sendButtonDoc(m.chat, msg, wm, 'Menu', '.menu', m, {
  mentions: conn.parseMention(msg),
  contextInfo: { 
    externalAdReply :{
    showAdAttribution: true,
    mediaUrl: 'wa.me/6289625556161',
    mediaType: 2,
    description: 'github.com/PilarV2', 
    title: 'BY PILAR',
    body: 'pilarv2.github.io',
    thumbnail: await(await fetch(img)).buffer(),
    sourceUrl: 'wa.me/6289625556161'
     }}
  })
}
...
global.flaaa = [
 'https://flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=water-logo&script=water-logo&fontsize=90&doScale=true&scaleWidth=300&scaleHeight=300&fontsize=100&fillTextColor=%23000&shadowGlowColor=%23000&backgroundColor=%23000&text=',
 'https://flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=crafts-logo&fontsize=90&doScale=true&scaleWidth=300&scaleHeight=300&text=',
 'https://flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=amped-logo&doScale=true&scaleWidth=300&scaleHeight=300&text=',
 'https://www6.flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=sketch-name&doScale=true&scaleWidth=300&scaleHeight=300&fontsize=100&fillTextType=1&fillTextPattern=Warning!&text=',
 'https://www6.flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=sketch-name&doScale=true&scaleWidth=300&scaleHeight=300&fontsize=100&fillTextType=1&fillTextPattern=Warning!&fillColor1Color=%23f2aa4c&fillColor2Color=%23f2aa4c&fillColor3Color=%23f2aa4c&fillColor4Color=%23f2aa4c&fillColor5Color=%23f2aa4c&fillColor6Color=%23f2aa4c&fillColor7Color=%23f2aa4c&fillColor8Color=%23f2aa4c&fillColor9Color=%23f2aa4c&fillColor10Color=%23f2aa4c&fillOutlineColor=%23f2aa4c&fillOutline2Color=%23f2aa4c&backgroundColor=%23101820&text='
]
